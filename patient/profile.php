...
<html lang="en">
	...
	<body>
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						<li class="nav-item"><a href="patient.php">Home</a></li>
						<li class="nav-item active"><a href="profile.php?patientId=<?php echo $userRow['icPatient']; ?>" class="nav-link">Profile</a></li>
						<li class="nav-item"><a href="patientapplist.php?patientId=<?php echo $userRow['icPatient']; ?>" class="nav-link">View Appointment</a></li>
		...
		<div class="container-fluid" style="background-image:url('assets/img/cover11.jpg'); background-size:cover; background-attachment:fixed; background-repeat:no-repeat;">
			<section style="padding-bottom: 50px; padding-top: 50px;" class="container">
				<div class="row">
					<!-- start -->
					...
					<div class="row">
						<div class="col-md-3 col-sm-3">
							...
							<div class="user-wrapper">
								<img src="assets/img/avatar.jpg" class="img-responsive" />
