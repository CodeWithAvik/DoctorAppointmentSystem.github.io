...
$res=mysqli_query($con,"SELECT * FROM admin WHERE icAdmin=".$usersession);
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="admin.php">Welcome <?php echo $userRow['adminFirstName'];?> <?php echo $userRow['adminLastName'];?></a>
                </div>
                <!-- Top Menu Items -->
                        ...
                        <table class="table table-hover table-bordered">
                            ...
                            while ($patientRow=mysqli_fetch_array($result)) {
                                ...
                                echo "<tr>";
                                    ...
                                    echo "<td class='text-center'><a href='#' id='".$patientRow['icPatient']."' class='delete'>DELETE</a>
                            </td>";
